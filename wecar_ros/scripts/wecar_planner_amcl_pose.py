...
class WeCarPlanner():
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_imu: ## WeBot 상태, 장애물 상태 점검
                ...
                self.servo_msg = self.steering*0.045 + self.steering_angle_to_servo_offset  # 조향값
    ...
    def amclCB(self, msg):  
        self.status_msg.position.x = msg.pose.pose.position.x
        self.status_msg.position.y = msg.pose.pose.position.y
