...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.rpm_output_topic  = rospy.get_param('~rpm_output_topic', 'nav_commands_motor_speed')
        ...
        self.servo_output_topic  = rospy.get_param('~servo_output_topic', 'nav_commands_servo_position')
